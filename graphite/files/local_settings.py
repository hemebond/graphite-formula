...
CONF_DIR = '/srv/graphite/conf'
STORAGE_DIR = '/srv/graphite/storage'
STATIC_ROOT = '/srv/graphite/static'
LOG_DIR = '/srv/graphite/storage/log/webapp'
INDEX_FILE = '/srv/graphite/storage/index'     # Search index file
...
DATABASES = {
    'default': {
        ...
        'ENGINE': 'django.db.backends.{{ graphite.database.type }}',
        'USER': '{{ graphite.database.user }}',
        'PASSWORD': '{{ graphite.database.password }}',
        'HOST': '{{ graphite.database.host }}',
        'PORT': '{{ graphite.database.port }}'
    }
}
